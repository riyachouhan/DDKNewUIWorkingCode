...
import com.ddkcommunity.fragment.SFIOSubFRagment;
...
public class SfioHeaderAdapterAll extends RecyclerView.Adapter<SfioHeaderAdapterAll.MyViewHolder>
{
    private List<sfioHeaderModel.BankDeposit> data;
    private Context activity;

    public SfioHeaderAdapterAll(List<sfioHeaderModel.BankDeposit> data, Context activity) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.sfioheadertablayoutall, parent, false);
        ...
        try
        {
            ...
            holder.uploadbutton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v)
                {
                    ...
                    String reasone="";
                    MainActivity.showDialogHeaderDataSubtitlw(reasone, SFIOSubFRagment.mAdapterher,position,data,id,activity);
                }
            });
