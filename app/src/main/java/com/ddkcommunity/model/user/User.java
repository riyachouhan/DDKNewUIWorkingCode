...
public class User {
    ...
    @SerializedName("is_user_photo_id_verified")
    @Expose
    private String is_user_photo_id_verified;
    ...
    public String getIs_user_photo_id_verified() {
        return is_user_photo_id_verified;
    }

    public void setIs_user_photo_id_verified(String is_user_photo_id_verified) {
        this.is_user_photo_id_verified = is_user_photo_id_verified;
    }
