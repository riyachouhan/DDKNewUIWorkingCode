...
public class grouptleveleadpater extends RecyclerView.Adapter<grouptleveleadpater.MyViewHolder> {

    private List<groupModel.LeftGroup> createCancellationRequestlist;
    private Activity activity;

    public grouptleveleadpater(List<groupModel.LeftGroup> createCancellationRequestlist, Activity activity) {
        this.createCancellationRequestlist=createCancellationRequestlist;
        this.activity = activity;
    }

    public void updateData(List<groupModel.LeftGroup> createCancellationRequestlist) {
        this.createCancellationRequestlist= createCancellationRequestlist;
