...
{
    private List<directReferralModel.Datum> data;
    private Activity activity;

    public DirectReferralAdapter(List<directReferralModel.Datum> data, Activity activity) {
        this.activity = activity;
        this.data = data;
    }

    public void updateData(List<directReferralModel.Datum> data) {
        this.data = data;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        try {
            ...
            holder.renewaltv.setText("Renewal : "+data.get(position).getRenewalNo());
            ...
            if(data.get(position).getStatus()!=null)
            {
                ...
                if (data.get(position).getStatus().equalsIgnoreCase("pool")) {
                ...
                }else if (data.get(position).getStatus().equalsIgnoreCase("pending")) {
