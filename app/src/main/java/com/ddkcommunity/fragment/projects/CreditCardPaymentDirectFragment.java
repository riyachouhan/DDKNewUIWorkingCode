 ...
 */
public class CreditCardPaymentDirectFragment extends Fragment {

    public String input_amount,conversion_rate,sam_koin_conversion,fee,total_usdt_subscription;

    public CreditCardPaymentDirectFragment()
    {
    ...
    String bidpositionid,bidposiiton,password,emailp;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (getArguments().getString("emailp") != null)
        {
            emailp= getArguments().getString("emailp");
        }
        //.......
