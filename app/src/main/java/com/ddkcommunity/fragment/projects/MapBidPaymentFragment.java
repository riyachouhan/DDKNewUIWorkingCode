 ...
 */
public class MapBidPaymentFragment extends Fragment implements View.OnClickListener
{
    Activity mContext;
    ...
    View view;
    String emailp,passwordp,bidposiiton,bidpositionid,payamt;

    public MapBidPaymentFragment()
    {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState)
    {
        ...
        view = inflater.inflate(R.layout.mapbidpaymentfragment, container, false);
        ...
        if(action.equalsIgnoreCase("bid"))
        {
            ...
            if (getArguments().getString("bidpositionid") != null) {
                bidpositionid= getArguments().getString("bidpositionid");
            }
            if (getArguments().getString("bidamount") != null)
            {
               // payamt= getArguments().getString("bidamount");
                payamt= "150";
            }
        }
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                }else
                {
                    ...
                    Fragment fragment = new CreditCardPaymentDirectFragment();
    ...
    private void sendMapDataServer(final BottomSheetDialog dialogNewbottom,final ProgressDialog dialogNew, final Activity activity, final String subscriptiontype, final String input_amount, final String conversion_rate, final String sam_koin_conversion, final String fee, final String total_usdt_subscription, final String transaction_id)
    {
        ...
        hm.put("pos_id",bidpositionid);
        hm.put("position",bidposiiton);
        //hm.put("password",passwordp);
        hm.put("email",emailp);
        ...
        Log.d("paramterHM",hm+"");
        AppConfig.getLoadInterfaceMap().mapDirectSubscription(maptoken, hm).enqueue(new Callback<directPurchesModel>() {
            @Override
            public void onResponse(Call<directPurchesModel> call, Response<directPurchesModel> response) {
                try
                {
                    Log.d("sam erro par invi",response.body().toString());
                        if (response.isSuccessful() && response.body() != null)
                        {
                            ...
                            {
                                dialogNew.dismiss();
                                String text_id=response.body().getData();
            ...
            @Override
            public void onFailure(Call<directPurchesModel> call, Throwable t)
            {
               dialogNew.dismiss();
                errordurigApiCalling(getActivity(),t.getMessage());
            }
